...
class MetamorphicTester(SchemaPruningMixin, BaseTester):
    def __init__(self):
    ...
    def _form_instance(self, idx, ret):
        ...
        if not self.schema_pruned:
            ...
            if snapshot_path and os.path.exists(snapshot_path):
                ...
                logging.warning("Pruned schema snapshot unavailable; rebuilding synchronously for MetamorphicTester.")
